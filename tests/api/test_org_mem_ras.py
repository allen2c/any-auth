...
def test_api_retrieve_organization_member_role_assignments_allowed(
    ...
    for user, token in [
        ...
        resp = test_api_client.get(
            f"/v1/organizations/{org_id}/members/{member_id}/rs",
            headers=headers,
        )
...
def test_api_create_organization_member_role_assignment_allowed(
    ...
    for user, token in [
        ...
        url = f"/v1/organizations/{org_id}/members/{member_id}/rs"
...
def test_api_delete_organization_member_role_assignment_allowed(
    ...
    for user, token in [
        ...
        url = f"/v1/organizations/{org_id}/members/{member_id}/rs/{assignment.id}"
